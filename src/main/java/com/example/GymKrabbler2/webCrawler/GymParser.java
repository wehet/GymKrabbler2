...
public class GymParser {
	...
	public String getTokensFromStart(String gesamt, String end) throws IOException {
		String result = "";
		String help = "";
	...
	public String getTokensFromBehind(String gesamt, String start) throws IOException {
		String result = "";
		String help = "";
		InputStream inputStream = getClass().getResourceAsStream("/models/de-token.bin");
		TokenizerModel model = new TokenizerModel(inputStream);
		...
		for (int i = startInt + 1; i < tokens.length; i++) {
			// Ggf. ausgliedern
			if (tokens[i].indexOf("00") != -1) {
				help = tokens[i].substring(0, tokens[i].indexOf("00") + 2) + " "
						+ tokens[i].substring(tokens[i].indexOf("00") + 2);
	...
	public String getTokens(String gesamt) throws IOException {
		String result = "";
		InputStream inputStream = getClass().getResourceAsStream("/models/de-token.bin");
		TokenizerModel model = new TokenizerModel(inputStream);
		TokenizerME tokenizer = new TokenizerME(model);
	...
	public static void main(String args[]) throws IOException {
		...
		String result = gymParser.getTokensFromStart(
				"Kaiserstraße 94 a \r\n" + " 76133 Karlsruhe\r\n" + " Tel.: 0721 – 663 37 37\r\n" + "\r\n"
